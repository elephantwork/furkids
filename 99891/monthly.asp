...
<html>
	<head>
		...
		<title>毛小孩幸福聯盟協會 - 定期定額捐款</title><meta charset="utf-8">
	...
	<body data-feedly-mini="yes" cz-shortcut-listen="true">
		<div class="wrapper">
			...
			<section class="section">
				...
				<p>目前協會收養的巨型犬約20隻左右，您可以指定狗狗認養，但是由於每隻狗狗每月開銷遠遠超過1000元，所以每隻狗狗不限制由一位主人認養，我們非常需要有更多的愛心主人可以加入認養行列，請於轉帳後來電或私訊確認，感謝您的愛心化為實際的行動！</p>
				<p>明照祇園有限公司是代為處理帳務的單位，會將捐款扣除支付平台手續費及營業稅後全額轉交毛小孩幸福聯盟</p>
			</section>
			<form class="supportform" action="step1.asp" method="post" name="form1" onsubmit="return chk()">
				...
				<div class="infoDonation">
					...
					<div class="item_field"><label>每月贊助金額</label><input type="text" name="money" value="1000"></div>
					<div class="item_field">
						<label>月份</label>
			...
			<section class="section">
				...
				<ul class="list clearfix">
					<li><img src="images/photo8.jpg" alt="認養狗狗：獒弟弟" /><small>認養狗狗：獒弟弟</small></li>
					<li><img src="images/photo5.jpg" alt="認養狗狗：獒娜娜" /><small>認養狗狗：獒娜娜</small></li>
					<li><img src="images/photo6.jpg" alt="認養狗狗：獒阿發" /><small>認養狗狗：獒阿發</small></li>
					<li><img src="images/photo7.jpg" alt="認養狗狗：大沅熊" /><small>認養狗狗：大沅熊</small></li>
				</ul>
			</section>
		...
		<footer id="footer">
			<div class="container">
				...
				<div class="copyright"><p>「社團法人臺北市毛小孩幸福聯盟協會」103證社字第140號 立案字號：北市社會字第2531號<br />© Copyright 2017 All Rights Reserved.</p></div>
			</div>
		</footer>
	</body>
</html>
